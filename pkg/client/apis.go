...
type APIsClient interface {
	// APIs
	CreateAPI(ctx context.Context, api *v1.API) (*v1.API, error)
	DeleteAPI(ctx context.Context, apiName string) (*v1.API, error)
	UpdateAPI(ctx context.Context, api *v1.API) (*v1.API, error)
	GetAPI(ctx context.Context, apiName string) (*v1.API, error)
	ListAPIs(ctx context.Context) ([]v1.API, error)
}

// NewAPIsClient is used to create a new APIs client
func NewAPIsClient(host string, auth runtime.ClientAuthInfoWriter) *DefaultAPIsClient {
...
func (c *DefaultAPIsClient) CreateAPI(ctx context.Context, api *v1.API) (*v1.API, error) {
...
func (c *DefaultAPIsClient) DeleteAPI(ctx context.Context, apiName string) (*v1.API, error) {
...
func (c *DefaultAPIsClient) UpdateAPI(ctx context.Context, api *v1.API) (*v1.API, error) {
...
func (c *DefaultAPIsClient) GetAPI(ctx context.Context, apiName string) (*v1.API, error) {
...
func (c *DefaultAPIsClient) ListAPIs(ctx context.Context) ([]v1.API, error) {
